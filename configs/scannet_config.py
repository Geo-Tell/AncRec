...
import numpy as np
from configs.path_config import SHAPENETCLASSES,scannet_path, raw_scans_path
...
class ScannetConfig(object):
    def __init__(self):
        ...
        self.mean_size_arr = np.load(os.path.join(scannet_path, 'scannet_means.npz'))['arr_0']
        self.type_mean_size = {}
        self.data_path = os.path.join(scannet_path, 'processed_data')
        self.scannet_raw_path = raw_scans_path
