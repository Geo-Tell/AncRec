...
def compute_quad_vote_loss(est_data, gt_data):
    ...
    # dist1, _, dist2, _ = nn_distance(vote_xyz, seed_gt_votes, l1=True)
...
def compute_objectness_loss(est_data, gt_data,dataset_config, valid_mask=None, return_loss=True):
    ...
    return objectness_label, assignment
