...
import copy
from configs.path_config import PathConfig, ScanNet_OBJ_CLASS_IDS, ScanNet_OBJ_CLASS_NAMES, shapenetid2class
import trimesh
...
def main_old(root_path, scene_file_name,output_path):
    ...
    bbox_params = np.load(os.path.join(pth, 'vis_bbox.npy'))
